...
void handle_init(void) {
  ...
  text_game_time_layer = text_layer_create(GRect(10, 20, 144, 65));
  text_period_layer = text_layer_create(GRect(0, 20, 144, 65));
  text_togo_layer = text_layer_create(GRect(0, 65, 72, 90));
  text_break_time_layer = text_layer_create(GRect(72, 65, 144, 80));
  text_added_time_layer = text_layer_create(GRect(72, 80, 144, 100));
  ...
  /* Font Setup */
  text_layer_set_font(text_game_time_layer, fonts_load_custom_font(FONT_AVERANGE_MONO_36));
  text_layer_set_font(text_period_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  text_layer_set_font(text_togo_layer, fonts_get_system_font(FONT_KEY_GOTHIC_28));
  text_layer_set_font(text_added_time_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  text_layer_set_font(text_break_time_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  /* Event Init */
